...
model.component('comp1').physics('spf').feature('BufferInl').set('p0',BufferInletPressure);  
...
model.component('comp1').physics('spf').feature('MainInl').set('p0', BufferInletPressure);
...
model.component('comp1').mesh('mesh1').autoMeshSize(1); %% finest 1, coarsest, 9
mesh1.run;
mee='meshing ends'
